...
set(CMAKE_FIND_ROOT_PATH_MODE_PACKAGE ONLY)''' % { 'winfix': '' if not WINDOWS else 'python ' }) \
  ...
  def closure_compiler(filename):
    ...
    #   java -Xmx1024m -jar CLOSURE_COMPILER --compilation_level
    #   ADVANCED_OPTIMIZATIONS --variable_map_output_file
    #   src.cpp.o.js.vars --js src.cpp.o.js --js_output_file
    #   src.cpp.o.cc.js
    args = [JAVA,
            ...
            '--externs', 'game-emscripten/lib.js',
