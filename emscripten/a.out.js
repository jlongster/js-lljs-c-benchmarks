...
function __Z10getCounterv() {
  ;
  var __label__;

  var $0=HEAP32[((_count)>>2)];
  var $inc=((($0)+(1))|0);
  HEAP32[((_count)>>2)]=$inc;
  var $1=HEAP32[((_count)>>2)];
  ;
  return $1;
}


function __Z5addIti($y) {
  ;
  var __label__;
...
function _main() {
  ...
  var $call=__Z10getCounterv();
  var $call1=__Z10getCounterv();
  var $call2=__Z10getCounterv();
  var $call3=__Z10getCounterv();
  var $call4=_printf(((STRING_TABLE.__str)|0), (tempInt=STACKTOP,STACKTOP += 4,assert(STACKTOP < STACK_ROOT + STACK_MAX, "Ran out of stack"),HEAP32[((tempInt)>>2)]=$call3,tempInt));
  var $call5=__Z5addIti(5);
  var $call6=_printf(((STRING_TABLE.__str)|0), (tempInt=STACKTOP,STACKTOP += 4,assert(STACKTOP < STACK_ROOT + STACK_MAX, "Ran out of stack"),HEAP32[((tempInt)>>2)]=$call5,tempInt));
...
_count=allocate(4, "i8", ALLOC_STATIC);
STRING_TABLE.__str=allocate([37,100,0] /* %d\00 */, "i8", ALLOC_STATIC);
...
// EMSCRIPTEN_GENERATED_FUNCTIONS: ["__Z10getCounterv","__Z5addIti","_main"]
